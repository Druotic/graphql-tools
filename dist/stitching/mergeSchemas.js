...
function mergeSchemas(_a) {
    var schemas = _a.schemas, onTypeConflict = _a.onTypeConflict, resolvers = _a.resolvers, inheritResolversFromInterfaces = _a.inheritResolversFromInterfaces;
    ...
    return mergeSchemasImplementation({ schemas: schemas, visitType: visitType, resolvers: resolvers, inheritResolversFromInterfaces: inheritResolversFromInterfaces });
}
exports.default = mergeSchemas;
function mergeSchemasImplementation(_a) {
    var schemas = _a.schemas, visitType = _a.visitType, resolvers = _a.resolvers, inheritResolversFromInterfaces = _a.inheritResolversFromInterfaces;
    var allSchemas = [];
    var typeCandidates = {};
    var types = {};
    var extensions = [];
